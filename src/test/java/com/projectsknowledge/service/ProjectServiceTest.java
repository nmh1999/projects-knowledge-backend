...
class ProjectServiceTest {
    ...
    void allEndpointsUseOnlyTheCurrentCatalogAndDoNotRetainRemovedProjects() {
        ...
        project.setId("dynamic-project"); project.setName("Runtime name"); project.setRepositories(List.of(repository));
        ...
        var service = new ProjectService(overviews, catalog);
        assertThat(service.findAll()).extracting(value -> value.name()).containsExactly("Runtime name");
        ...
        assertThatThrownBy(() -> service.requireRepository("dynamic-repository")).isInstanceOf(KnowledgeException.class);
    ...
    void propagatesCatalogFailureInsteadOfShowingConfiguredProjects() {
        ...
        var service = new ProjectService(mock(ProjectOverviewService.class), catalog);
