...
public class SecretRedactionService {
    private static final List<String> SENSITIVE_KEYS = List.of(
            "password", "secret", "client-secret", "client_secret", "api-key", "api_key",
            "token", "private-key", "private_key", "access-key", "access_key", "credentials"
    );
    private static final Pattern PRIVATE_KEY = Pattern.compile("-----BEGIN(?:[ A-Z]+)? PRIVATE KEY-----.*", Pattern.CASE_INSENSITIVE);
