...
final class RepositoryStructure {
    ...
    private static final Set<String> INTEGRATION_CONTAINERS = Set.of("integrations", "connectors", "adapters", "clients");
    ...
    private static List<String> discover(Path root, List<Path> files, Set<String> containers, boolean includeClients, int limit) {
